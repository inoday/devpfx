...
{	
	...
	public function secure($process) {
		$data = Phpfox::getLib('request')->send('https://secure.moxi9.com/js?process=' . $process, array('token' => Phpfox::getLib('request')->get('token')), 'POST');
