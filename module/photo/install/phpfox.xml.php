<module>
	<data>
		...
		<app_name>Photos</app_name>
		<writable><![CDATA[a:1:{i:0;s:15:"file/pic/photo/";}]]></writable>
	</data>
	<menus>
		<menu module_id="photo" parent_var_name="" m_connection="main" var_name="menu_photo" ordering="5" url_value="photo" version_id="2.0.0alpha1" disallow_access="" module="photo" />
		<menu module_id="photo" parent_var_name="" m_connection="profile" var_name="menu_photos" ordering="22" url_value="profile.photo" version_id="2.0.0alpha1" disallow_access="" module="photo" />
		<menu module_id="photo" parent_var_name="" m_connection="photo.index" var_name="menu_photo_upload_a_new_image_714586c73197300f65ba08f7dee8cb4a" ordering="52" url_value="photo.add" version_id="3.3.0beta2" disallow_access="" module="photo" />
		...
		<menu module_id="photo" parent_var_name="" m_connection="photo.albums" var_name="menu_photo_upload_a_new_image_0df7df42d810e7978c535292f273fc91" ordering="53" url_value="photo.add" version_id="3.5.0beta1" disallow_access="" module="photo" />
	</menus>
	<settings>
  ...
  5 => '1024'
		...
		<setting group="" module_id="photo" is_hidden="0" type="large_string" var_name="photo_meta_description" phrase_var_name="setting_photo_meta_description" ordering="8" version_id="2.0.0rc1">Check out our photo gallery.</setting>
		<setting group="" module_id="photo" is_hidden="0" type="large_string" var_name="photo_meta_keywords" phrase_var_name="setting_photo_meta_keywords" ordering="14" version_id="2.0.0rc1">photo, photos, albums, gallery</setting>
		...
		<setting group="" module_id="photo" is_hidden="0" type="integer" var_name="how_many_categories_to_show_in_title" phrase_var_name="setting_how_many_categories_to_show_in_title" ordering="15" version_id="2.0.4">0</setting>
		...
		<setting group="" module_id="photo" is_hidden="1" type="integer" var_name="total_photo_input_bars" phrase_var_name="setting_total_photo_input_bars" ordering="1" version_id="2.0.0alpha1">5</setting>
		<setting group="" module_id="photo" is_hidden="1" type="boolean" var_name="show_info_on_mouseover" phrase_var_name="setting_show_info_on_mouseover" ordering="1" version_id="3.5.0beta1">1</setting>
		<setting group="" module_id="photo" is_hidden="1" type="boolean" var_name="auto_crop_photo" phrase_var_name="setting_auto_crop_photo" ordering="1" version_id="3.0.0beta1">1</setting>
