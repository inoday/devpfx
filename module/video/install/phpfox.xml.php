<module>
	...
	<menus>
		<menu module_id="video" parent_var_name="" m_connection="main" var_name="menu_video" ordering="8" url_value="video" version_id="2.0.0alpha1" disallow_access="" module="video" />
		<menu module_id="video" parent_var_name="" m_connection="video.index" var_name="menu_upload_a_new_video" ordering="46" url_value="video.add" version_id="2.0.0beta2" disallow_access="" module="video" />
		<menu module_id="video" parent_var_name="" m_connection="profile" var_name="menu_videos" ordering="25" url_value="profile.video" version_id="2.0.0beta2" disallow_access="" module="video" />
	...
	<settings>
		<setting group="" module_id="video" is_hidden="0" type="string" var_name="video_time_stamp" phrase_var_name="setting_video_time_stamp" ordering="4" version_id="2.0.0beta2">F j, Y</setting>
		...
		<setting group="" module_id="video" is_hidden="0" type="large_string" var_name="video_meta_keywords" phrase_var_name="setting_video_meta_keywords" ordering="11" version_id="2.0.0rc1">video, sharing, free, upload</setting>
		<setting group="" module_id="video" is_hidden="0" type="large_string" var_name="video_meta_description" phrase_var_name="setting_video_meta_description" ordering="17" version_id="2.0.0rc1">Share your videos with friends, family, and the world on Site Name.</setting>
		...
		<setting group="" module_id="video" is_hidden="0" type="boolean" var_name="enabled_embedly_import" phrase_var_name="setting_enabled_embedly_import" ordering="1" version_id="3.0.1">1</setting>
		<setting group="" module_id="video" is_hidden="0" type="string" var_name="embedly_api_key" phrase_var_name="setting_embedly_api_key" ordering="2" version_id="3.0.1" />
