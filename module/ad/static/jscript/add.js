...
{
	if ($('#js_sample_multi_ad_holder').length) {
		p('test');
		var this_offset = $('#js_sample_multi_ad_holder').offset();
		$('#js_sample_multi_ad_holder').css({
			position: 'fixed',
	...
	$('#title').keyup(function()
	{
		...
		limitChars(this, 40, 'js_ad_title_form_limit');
