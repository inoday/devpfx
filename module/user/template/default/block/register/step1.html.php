	<div id="js_register_step1">
		...
		<div class="table">
			<div class="table_right table_right_input">
				<input type="text" name="val[full_name]" id="full_name" value="{value type='input' id='full_name'}" placeholder="{phrase var='user.full_name'}" size="30" />
			</div>			
		</div>
		{/if}
		...
		<div class="table">
			<div class="table_right table_right_input">
				<input type="text" name="val[email]" id="email" value="{value type='input' id='email'}" placeholder="{phrase var='user.email'}" size="30" />
			</div>			
		</div>
		{if Phpfox::getParam('user.reenter_email_on_signup')}
		<div class="table">
