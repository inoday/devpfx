<module>
	<data>
		...
		<is_menu>1</is_menu>
		<menu><![CDATA[a:1:{s:22:"user.admin_menu_search";a:1:{s:3:"url";a:2:{i:0;s:4:"user";i:1;s:6:"browse";}}}]]></menu>
	...
	<menus>
		<menu module_id="user" parent_var_name="" m_connection="user.setting" var_name="menu_privacy_settings" ordering="35" url_value="user.privacy" version_id="2.0.0alpha1" disallow_access="" module="user" />
		<menu module_id="user" parent_var_name="" m_connection="main" var_name="menu_browse" ordering="2" url_value="user.browse" version_id="2.0.0alpha1" disallow_access="" module="user" />
		...
		<menu module_id="user" parent_var_name="" m_connection="user.setting" var_name="menu_account_settings" ordering="34" url_value="user.setting" version_id="2.0.0alpha1" disallow_access="" module="user" />
		<menu module_id="user" parent_var_name="" m_connection="profile.my" var_name="menu_edit_profile_picture" ordering="29" url_value="user.photo" version_id="2.0.0alpha1" disallow_access="" module="user" />
		<menu module_id="user" parent_var_name="" m_connection="user.privacy" var_name="menu_account_settings" ordering="40" url_value="user.setting" version_id="2.0.0alpha2" disallow_access="" module="user" />
		<menu module_id="user" parent_var_name="" m_connection="user.privacy" var_name="menu_privacy_settings" ordering="41" url_value="user.privacy" version_id="2.0.0alpha2" disallow_access="" module="user" />
		<menu module_id="user" parent_var_name="" m_connection="profile.my" var_name="menu_edit_profile" ordering="28" url_value="user.profile" version_id="2.0.0alpha3" disallow_access="" module="user" />
  ...
  6 => '200',
		...
		<setting group="" module_id="user" is_hidden="1" type="boolean" var_name="split_full_name" phrase_var_name="setting_split_full_name" ordering="1" version_id="3.4.0beta1">0</setting>
		<setting group="cache" module_id="user" is_hidden="1" type="boolean" var_name="cache_user_inner_joins" phrase_var_name="setting_cache_user_inner_joins" ordering="2" version_id="3.6.0rc1">0</setting>
	</settings>
	<blocks>
...
(This setting does not affect the AdminCP)</phrase>
		...
		<phrase module_id="user" version_id="4.0.0beta1" var_name="admin_menu_search" added="1408474285">Search</phrase>
	</phrases>
	<user_group_settings>
