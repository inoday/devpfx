<module>
	<data>
		...
		<app_name>Polls</app_name>
		<writable><![CDATA[a:1:{i:0;s:14:"file/pic/poll/";}]]></writable>
	</data>
	<menus>
		<menu module_id="poll" parent_var_name="" m_connection="main" var_name="menu_poll" ordering="7" url_value="poll" version_id="2.0.0alpha1" disallow_access="" module="poll" />
		<menu module_id="poll" parent_var_name="" m_connection="poll.index" var_name="menu_add_new_poll" ordering="36" url_value="poll.add" version_id="2.0.0alpha1" disallow_access="" module="poll" />
		<menu module_id="poll" parent_var_name="" m_connection="profile" var_name="menu_polls" ordering="23" url_value="profile.poll" version_id="2.0.0alpha1" disallow_access="" module="poll" />
	...
	<settings>
		...
		<setting group="" module_id="poll" is_hidden="0" type="large_string" var_name="poll_meta_description" phrase_var_name="setting_poll_meta_description" ordering="9" version_id="2.0.0rc1">New polls on Site Name daily.</setting>
		<setting group="" module_id="poll" is_hidden="0" type="large_string" var_name="poll_meta_keywords" phrase_var_name="setting_poll_meta_keywords" ordering="15" version_id="2.0.0rc1">poll, polls</setting>
	</settings>
	<hooks>
