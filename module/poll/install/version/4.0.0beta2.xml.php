<upgrade>
	<phpfox_update_settings>
		...
		<setting>
			...
			<is_hidden>0</is_hidden>
			<type>large_string</type>
			<var_name>poll_meta_keywords</var_name>
			<phrase_var_name>setting_poll_meta_keywords</phrase_var_name>
			<ordering>15</ordering>
			<version_id>2.0.0rc1</version_id>
			<value>poll, polls</value>
		</setting>
	</phpfox_update_settings>
	<phpfox_update_menus>
		<menu>
		...
		<menu>
			<module_id>poll</module_id>
			<parent_var_name />
			<m_connection>poll.index</m_connection>
			<var_name>menu_add_new_poll</var_name>
			<ordering>36</ordering>
			<url_value>poll.add</url_value>
			<version_id>2.0.0alpha1</version_id>
			<disallow_access />
			<module>poll</module>
			<value />
		...
		<menu>
			...
			<var_name>menu_polls</var_name>
			<ordering>23</ordering>
			<url_value>profile.poll</url_value>
			<version_id>2.0.0alpha1</version_id>
			<disallow_access />
			<module>poll</module>
			<value />
