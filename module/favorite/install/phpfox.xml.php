<module>
	...
	<menus>
		<menu module_id="favorite" parent_var_name="" m_connection="profile" var_name="menu_favorites" ordering="26" url_value="profile.favorite" version_id="2.0.0beta3" disallow_access="" module="favorite" />
	</menus>
	<hooks>
