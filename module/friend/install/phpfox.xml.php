<module>
	<data>
		...
		<menu />
		<phrase_var_name />
		<app_name>Friends</app_name>
		<writable />
	</data>
	<menus>
		<menu module_id="friend" parent_var_name="" m_connection="profile" var_name="menu_friend_friends" ordering="21" url_value="profile.friend" version_id="2.0.0alpha1" disallow_access="" module="friend" />
	...
	<settings>
		...
		<setting group="" module_id="friend" is_hidden="0" type="large_string" var_name="friend_meta_keywords" phrase_var_name="setting_friend_meta_keywords" ordering="7" version_id="2.0.0rc1">friends, buddies</setting>
		...
		<setting group="cache" module_id="friend" is_hidden="1" type="boolean" var_name="load_friends_online_ajax" phrase_var_name="setting_load_friends_online_ajax" ordering="6" version_id="3.6.0rc1">1</setting>
	</settings>
	<blocks>
		...
		<block type_id="0" m_connection="profile.index" module_id="friend" component="mutual-friend" location="3" is_active="1" ordering="6" disallow_access="" can_move="1">
