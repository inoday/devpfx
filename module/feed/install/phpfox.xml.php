<module>
	<data>
		...
		<app_name>Activity Feed</app_name>
		<writable />
	</data>
	<menus>
	...
	<settings>
		...
		<setting group="" module_id="feed" is_hidden="1" type="boolean" var_name="force_timeline" phrase_var_name="setting_force_timeline" ordering="1" version_id="3.3.0beta1">0</setting>
		<setting group="" module_id="feed" is_hidden="1" type="boolean" var_name="can_add_past_dates" phrase_var_name="setting_can_add_past_dates" ordering="1" version_id="3.3.0beta1">0</setting>
		<setting group="" module_id="feed" is_hidden="1" type="boolean" var_name="timeline_optional" phrase_var_name="setting_timeline_optional" ordering="1" version_id="3.3.0beta1">0</setting>
		<setting group="" module_id="feed" is_hidden="1" type="boolean" var_name="add_feed_for_comments" phrase_var_name="setting_add_feed_for_comments" ordering="1" version_id="3.4.0beta1">0</setting>
		<setting group="cache" module_id="feed" is_hidden="1" type="boolean" var_name="force_ajax_on_load" phrase_var_name="setting_force_ajax_on_load" ordering="1" version_id="3.6.0rc1">1</setting>
	...
	<blocks>
		...
		<block type_id="0" m_connection="core.index-member" module_id="feed" component="display" location="2" is_active="1" ordering="3" disallow_access="" can_move="0">
			<title>Activity Feed</title>
			<source_code />
			<source_parsed />
		</block>
		<block type_id="0" m_connection="profile.index" module_id="feed" component="display" location="2" is_active="1" ordering="9" disallow_access="" can_move="0">
			<title></title>
			<source_code />
			<source_parsed />
		</block>
		...
		<block type_id="0" m_connection="profile.index" module_id="feed" component="time" location="3" is_active="1" ordering="5" disallow_access="" can_move="0">
