<module>
	<data>
		...
		<app_name>Invite</app_name>
		<writable />
	</data>
	<menus>
		<menu module_id="invite" parent_var_name="" m_connection="footer" var_name="menu_invite" ordering="14" url_value="invite" version_id="2.0.0alpha1" disallow_access="" module="invite" />
		<menu module_id="invite" parent_var_name="" m_connection="invite" var_name="menu_pending_invitations" ordering="38" url_value="invite.invitations" version_id="2.0.0alpha1" disallow_access="" module="invite" />
		<menu module_id="invite" parent_var_name="" m_connection="invite" var_name="menu_invite_friends" ordering="37" url_value="invite" version_id="2.0.0alpha1" disallow_access="" module="invite" />
	</menus>
	<settings>
