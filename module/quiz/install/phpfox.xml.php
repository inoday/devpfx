<module>
	<data>
		...
		<app_name>Quizzes</app_name>
		<writable><![CDATA[a:1:{i:0;s:14:"file/pic/quiz/";}]]></writable>
	</data>
	<menus>
		<menu module_id="quiz" parent_var_name="" m_connection="main" var_name="menu_quiz" ordering="9" url_value="quiz" version_id="2.0.0alpha1" disallow_access="" module="quiz" />
		<menu module_id="quiz" parent_var_name="" m_connection="profile" var_name="menu_profile_quiz" ordering="24" url_value="profile.quiz" version_id="2.0.0alpha1" disallow_access="" module="quiz" />
		<menu module_id="quiz" parent_var_name="" m_connection="quiz" var_name="menu_add_new_quiz" ordering="39" url_value="quiz.add" version_id="2.0.0alpha1" disallow_access="" module="quiz" />
	...
	<settings>
		...
		<setting group="" module_id="quiz" is_hidden="0" type="large_string" var_name="quiz_meta_keywords" phrase_var_name="setting_quiz_meta_keywords" ordering="10" version_id="2.0.0rc1">quiz, test, online, quizzes, tests, free, cool, fun</setting>
		<setting group="" module_id="quiz" is_hidden="0" type="large_string" var_name="quiz_meta_description" phrase_var_name="setting_quiz_meta_description" ordering="16" version_id="2.0.0rc1"><![CDATA[Take Free Fun Quizzes & Tests. Cool Online Fun Quiz & Test. Fun Quizzes and Fun Tests by Site Name.]]></setting>
	</settings>
	<blocks>
