<module>
	...
	<menus>
		<menu module_id="page" parent_var_name="" m_connection="footer" var_name="menu_terms" ordering="15" url_value="terms" version_id="2.0.0alpha1" disallow_access="" module="page" />
	</menus>
	<hooks>
