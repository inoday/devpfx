<module>
	...
	<menus>
		...
		<menu module_id="profile" parent_var_name="" m_connection="profile" var_name="menu_profile" ordering="19" url_value="profile" version_id="2.0.0alpha1" disallow_access="" module="profile" />
		<menu module_id="profile" parent_var_name="" m_connection="profile.my" var_name="menu_customize_profile" ordering="30" url_value="profile.designer" version_id="2.0.0alpha3" disallow_access="" module="profile" />
		<menu module_id="profile" parent_var_name="" m_connection="profile.my" var_name="menu_my_profile" ordering="27" url_value="profile" version_id="2.0.0alpha3" disallow_access="" module="profile" />
	...
	<settings>
		...
		<setting group="" module_id="profile" is_hidden="0" type="string" var_name="profile_seo_for_meta_title" phrase_var_name="setting_profile_seo_for_meta_title" ordering="5" version_id="2.0.0rc4">{full_name} - {gender_name} - {location}</setting>
		...
		<setting group="cache" module_id="profile" is_hidden="1" type="boolean" var_name="cache_blocks_design" phrase_var_name="setting_cache_blocks_design" ordering="1" version_id="3.6.0rc1">1</setting>
