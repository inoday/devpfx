<module>
	<data>
		...
		<is_menu>1</is_menu>
		<menu><![CDATA[a:1:{s:27:"event.admin_menu_categories";a:1:{s:3:"url";a:1:{i:0;s:5:"event";}}}]]></menu>
		<phrase_var_name>module_event</phrase_var_name>
		<app_name>Events</app_name>
		<writable><![CDATA[a:1:{i:0;s:15:"file/pic/event/";}]]></writable>
	</data>
	<menus>
		<menu module_id="event" parent_var_name="" m_connection="main" var_name="menu_event" ordering="10" url_value="event" version_id="2.0.0alpha1" disallow_access="" module="event" />
		<menu module_id="event" parent_var_name="" m_connection="event.index" var_name="menu_create_new_event" ordering="43" url_value="event.add" version_id="2.0.0alpha4" disallow_access="" module="event" />
...
<a href="{link}">{link}</a>]]></phrase>
		...
		<phrase module_id="event" version_id="4.0.0beta1" var_name="admin_menu_categories" added="1408472916">Categories</phrase>
	</phrases>
	<rss_group>
